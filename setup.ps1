...
Write-Host "[2/6] Checking fnm..." -ForegroundColor Yellow
...
Write-Host "[3/6] Checking 7-Zip..." -ForegroundColor Yellow
...
Write-Host "[4/6] Checking PowerShell profile..." -ForegroundColor Yellow
...
Write-Host "[6/6] Building Firefox extension..." -ForegroundColor Yellow
npm run package
